...
import { ensurePortalAuthSchema, ensureRegistrationFormsSchema, ensureAcademicResultsSchema, ensureAssessmentSchema, ensureTeacherStatusSchema } from './db/ensureSchema.js';
...
async function start() {
  try {
    ...
    await ensureTeacherStatusSchema();

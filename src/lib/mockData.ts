...
export type SchoolCheckInConfidentiality =
  | "identified"
  | "restricted"
  | "anonymous";
...
export const mockTeachers: Teacher[] = [
  ...
  },
  {
    id: "tch-english-1",
    name: "Sarah Thompson",
    email: "sarah.thompson@prime.edu.et",
    ...
    certification: "Cambridge CELTA Certified",
    trainingProgress: 70,
    yearsOfExperience: 8,
  },
  {
    id: "tch-intl-1",
    name: "James Anderson",
    email: "james.anderson@prime.edu.et",
    phone: "+251-917-889900",
    departmentId: "dept-math",
    schoolId: "sch-1",
    status: "Active",
    subjects: ["Mathematics (IGCSE)", "Mathematics (IB)"],
    grades: ["Grade 9", "Grade 10", "Grade 11"],
    certification: "IB Diploma Programme Certified",
    trainingProgress: 55,
...
export const mockLessonPlans: LessonPlan[] = [
  {
    ...
    status: "Approved",
    deptComments:
      "Excellent structure. Added resources references. Recommended approval.",
    version: 2,
    objectives: [
    ...
    activities: [
      {
        session: 1,
        activity: "Introduction to Cell Structure & Microscope usage",
        duration: "40 mins",
      },
      {
        session: 2,
        activity: "Plant vs Animal Cells laboratory diagram review",
        duration: "45 mins",
      },
      {
        session: 3,
        activity: "Membrane structure and passive transport group quiz",
        duration: "45 mins",
      },
      {
        session: 4,
        activity: "Active transport model builder using clay",
        duration: "45 mins",
      },
      {
        session: 5,
        activity: "Practical quiz & chapter completion analysis",
        duration: "50 mins",
      },
    ],
    assessments: [
      "Quiz on Membrane Transport",
      "Syllabus alignment lab sheet",
      "Active transport presentation",
    ],
    homework:
      "Write a 200-word paragraph describing why mitochondrion is called the powerhouse of the cell.",
  ...
  },
  {
    ...
    activities: [
      {
        session: 1,
        activity: "DNA structure review and replication animation",
        duration: "45 mins",
      },
      {
        session: 2,
        activity: "Membrane transport recap and lab prep",
        duration: "45 mins",
      },
      {
        session: 3,
        activity: "Protein synthesis modeling activity",
        duration: "50 mins",
      },
  ...
  },
  {
    ...
    activities: [
      {
        session: 1,
        activity: "Factoring quadratic trinomials board exercises",
        duration: "45 mins",
      },
      {
        session: 2,
        activity: "Deriving the quadratic formula step-by-step",
        duration: "45 mins",
      },
      {
        session: 3,
        activity: "Discriminant analysis of real vs imaginary solutions",
        duration: "45 mins",
      },
      {
        session: 4,
        activity: "Practical physics examples (projectile motion graphs)",
        duration: "45 mins",
      },
    ],
    assessments: [
      "Discriminant homework sheet",
      "Challenging projectile worksheet",
    ],
    homework:
      "Solve problems 1-15 on page 84 of the Grade 10 Ethiopian Math Textbook.",
  ...
  },
  {
    ...
    activities: [
      {
        session: 1,
        activity: "Lewis structures of water and ammonia",
        duration: "40 mins",
      },
      {
        session: 2,
        activity: "Building ball-and-stick geometry mockups",
        duration: "50 mins",
      },
      {
        session: 3,
        activity: "VSEPR shape worksheets group evaluation",
        duration: "45 mins",
      },
      {
        session: 4,
        activity: "Hybrid orbital energy level diagrams review",
        duration: "45 mins",
      },
      {
        session: 5,
        activity: "Double and triple bond overlap simulations",
        duration: "45 mins",
      },
      {
        session: 6,
        activity: "Wrap-up chemistry laboratory safe practice",
        duration: "40 mins",
      },
    ],
    assessments: ["VSEPR structures test", "Covalent bonding homework"],
    homework:
      "Draw orbital overlap diagrams for methane (CH4) and ethene (C2H4).",
  ...
  },
  {
    ...
    activities: [
      {
        session: 1,
        activity: "Free-body diagram workshop",
        duration: "45 mins",
      },
    ],
  ...
  },
  {
    ...
    activities: [
      {
        session: 1,
        activity: "Identity proof board work",
        duration: "45 mins",
      },
    ],
...
export const mockAssessments: Assessment[] = [
  {
    ...
    questions: [
      ...
      },
      {
        id: 2,
        question:
          "Osmosis is the net movement of water from high to low solute concentration.",
        type: "True/False",
        answer: "False",
      },
      {
        id: 3,
        question:
          "Explain the primary differences between eukaryotic and prokaryotic cells.",
        type: "Essay",
        answer:
          "Eukaryotes have a membrane-bound nucleus and membrane-bound organelles (e.g. mitochondria), whereas prokaryotes lack a defined nucleus and their DNA is circular and floats in the nucleoid region.",
      },
    ],
    ...
    questions: [
      {
        id: 1,
        question:
          "What is the discriminant of the quadratic equation 3x^2 - 5x + 2 = 0?",
        type: "Short Answer",
        answer: "1",
      },
      {
        id: 2,
        question:
          "If the discriminant is negative, the equation has two distinct real roots.",
        type: "True/False",
        answer: "False",
      },
      {
        ...
        type: "MCQ",
        options: ["x=3, x=4", "x=-3, x=-4", "x=2, x=6", "x=0"],
        answer: "x=3, x=4",
      },
    ],
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: "Define pH scale range for acidic solutions.",
        type: "Short Answer",
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: "Name the control center of the cell.",
        type: "Short Answer",
        answer: "Nucleus",
      },
    ],
...
export const mockAttendanceRecords: Attendance[] = [
  ...
  },
  {
    ...
    date: "2026-05-20",
    status: "Absent",
    remarks: "Sick leave (Flu)",
  },
  {
    id: "att-3",
    studentId: "std-4",
    studentName: "Tariku Tigist",
    grade: "Grade 9",
    section: "A",
    date: "2026-05-20",
    status: "Late",
    remarks: "Late by 10 mins (Traffic)",
  },
  {
    id: "att-4",
    studentId: "std-1",
...
export const mockTrainingPrograms: TeacherTraining[] = [
  {
    id: "tr-1",
    title: "Pedagogy & Inclusive Learning for Secondary Classrooms",
    instructor: "Dr. Zenebe Lema (AAU)",
  ...
  {
    id: "tr-2",
    title: "AI for Education: Integrating Digital Tools in Science & Math",
    instructor: "Martha Wolde (MOE Lead)",
  ...
  {
    id: "tr-3",
    title: "Continuous Assessment & Grading rubrics alignment",
    instructor: "Ato Solomon Tessema",
...
export const mockCheckIns: SchoolCheckIn[] = [
  ...
  },
  {
    id: "ch-5",
    type: "Wellness",
    respondentName: "W/ro Almaz Tekle",
    rating: 3,
    comment:
...
export const mockDepartments: Department[] = [
  ...
  },
  {
    ...
    headName: "Ato Belayneh Kassahun",
    teachersCount: 2,
    subjectsCount: 1,
    status: "Active",
  },
...
export const mockClasses: SchoolClass[] = [
  {
    ...
    grade: "Grade 9",
    section: "A",
    homeroomTeacher: "Martha Feyissa",
    studentsCount: 42,
  },
  {
    id: "cls-2",
  ...
  },
  {
    ...
    grade: "Grade 10",
    section: "A",
    homeroomTeacher: "W/ro Almaz Tekle",
    studentsCount: 38,
  },
  {
    id: "cls-4",
    ...
    grade: "Grade 11",
    section: "A",
    homeroomTeacher: "Ato Belayneh Kassahun",
    studentsCount: 35,
  },
  {
    id: "cls-5",
    ...
    grade: "Grade 12",
    section: "A",
    homeroomTeacher: "W/t Selamawit Hailu",
    studentsCount: 30,
  },
];
...
export const mockExams: ExamPaper[] = [
  ...
  {
    id: "ex-3",
    title: "Physics Grade 12 National Mid Exam",
    type: "Mid Exam",
    subject: "Physics",
    grade: "Grade 12",
    departmentId: "dept-stem",
...
export const mockTrainingMaterials: TrainingMaterial[] = [
  {
    id: "tm-1",
    title: "MOE Modern Secondary Pedagogy Guide v2",
    resourceUrl: "#",
    category: "Pedagogy",
    trainingType: "MOE Mandatory",
    uploadedAt: "2026-05-10",
    disseminated: true,
  },
  {
    id: "tm-2",
    title: "Inclusion & Classroom Management Guide",
    resourceUrl: "#",
  ...
  {
    id: "tm-3",
    title: "STEM Lab Safety & Practical Assessment Rubric",
    resourceUrl: "#",
    category: "STEM",
    trainingType: "STEM",
    departmentId: "dept-stem",
  ...
  {
    id: "tm-4",
    title: "Grade 9–12 Biology Syllabus Alignment Pack",
    resourceUrl: "#",
    category: "Biology",
  ...
  {
    id: "tm-6",
    title: "Mathematics Grade 9–12 Problem-Solving Framework",
    resourceUrl: "#",
...
export const mockTeachingNotes: TeachingNote[] = [
  {
    ...
    language: "English",
    contentSummary:
      "AI-generated notes covering mitochondria, ATP synthesis, and aerobic pathways.",
    status: "Saved",
  ...
  },
  {
    ...
    language: "English",
    contentSummary:
      "Student handout for passive and active transport with diagram prompts.",
    status: "Saved",
...
export const mockTeacherFeedbacks: TeacherFeedback[] = [
  {
    ...
    comment:
      "Strong pedagogical sequencing. Consider adding a formative check in session 2.",
    rating: 5,
    date: "2026-05-18",
  },
  {
    ...
    comment:
      "Excellent microscope technique and group collaboration during the genetics lab.",
    date: "2026-05-19",
  },
  {
    id: "tfb-3",
    ...
    comment:
      "Please attend extra tutorial sessions to recover missed practicum hours.",
    date: "2026-05-20",
  },
];
...
export const mockParentMessages: ParentMessage[] = [
  {
    ...
    message:
      "Dear parent — Yonas attendance has dropped below 86%. Please confirm if a parent-teacher meeting works this week.",
    sentAt: "2026-05-20",
  },
];
...
export const mockTeacherCheckInPrompts: TeacherCheckInPrompt[] = [
  ...
  },
  {
    ...
    dueDate: "2026-05-30",
    teacherResponse:
      "Students were highly engaged during the genetics practicum; pacing on session 3 could improve.",

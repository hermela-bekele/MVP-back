export const PERMISSIONS = [
  ...
  { code: 'staffing.request', label: 'Request MOE teacher replacement (Public schools)', module: 'hr' },
  { code: 'staffing.assign', label: 'Assign / transfer teachers for Public schools', module: 'hr' },
  ...
  { code: 'training.manage', label: 'Manage training resources and programs', module: 'academics' },
  { code: 'practice.manage', label: 'Manage practice sets', module: 'academics' },
  { code: 'resources.manage', label: 'Manage the school external resource library', module: 'academics' },
  { code: 'surveys.manage', label: 'Publish wellness and satisfaction surveys', module: 'academics' },
  ...
  { code: 'messages.school_moe', label: 'School head–MOE messages', module: 'comms' },
  ...
  { code: 'regions.manage', label: 'Manage MOE regions', module: 'admin' },
  { code: 'schools.connect', label: 'Connect / activate schools in PRIME EduAI', module: 'admin' },
  { code: 'leadership.manage_actions', label: 'Manage leadership actions and improvement initiatives', module: 'admin' },
  { code: 'compliance.view', label: 'View compliance requirements and status', module: 'admin' },
  { code: 'compliance.manage', label: 'Create compliance requirements and verify school submissions', module: 'admin' },
  { code: 'compliance.track', label: 'Update own school compliance status and evidence', module: 'admin' },
